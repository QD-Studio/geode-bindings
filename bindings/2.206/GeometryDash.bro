...
class CameraTriggerGameObject : EffectGameObject {
	...
	virtual void triggerObject(GJBaseGameLayer*, int, gd::vector<int> const*) = m1 0x18fd50;
...
class GameLevelManager : cocos2d::CCNode {
	...
	static GameLevelManager* sharedState() = win 0x13e1e0, m1 0x478590;
...
class GauntletLayer : cocos2d::CCLayer, LevelManagerDelegate {
	...
	bool init(GauntletType) = win 0x1e93d0;
	void onBack(cocos2d::CCObject* sender);
...
class GJBaseGameLayer : cocos2d::CCLayer, TriggerEffectDelegate {
	...
	void createBackground(int) = win 0x1fc5d0;
	...
	GJGameEvent objectTypeToGameEvent(int) = m1 0xf5ca0;
	...
	PAD = win 0x8, android32 0x4, android64 0x8, mac 0x8; // mac not verified
...
class MultilineBitmapFont : cocos2d::CCSprite {
	...
	PAD = android32 0x4B0, win 0x4B0, android64 0x4B0;
...
class PlayerObject : GameObject, AnimatedSpriteDelegate {
	...
	TodoReturn flipMod();
	TodoReturn gameEventTriggered(int, int) = m1 0xf2c98;
	bool getActiveMode();
